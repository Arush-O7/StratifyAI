          ...
          <Card className="p-8 sm:p-10" hoverGlow={false}>
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-slate-400 mt-1.5">
                Register to establish a secure StratifyAI tenant
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-slate-950/60 border border-white/5 rounded-xl text-white text-xs placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-slate-950 border border-white/5 rounded-xl text-white text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
                >
                  <option value="product-manager" className="bg-slate-950">Product Manager</option>
                  <option value="developer" className="bg-slate-950">Developer / Engineer</option>
